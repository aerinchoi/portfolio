(() => {
  ...
  const sceneInfo = [
    {
      ...
      values: {
        videoImageCount: 300,//비디오 이미지 총 갯수
        imageSequence: [0, 299], //스크롤에 따른 이미지 순서
  ...
  window.addEventListener('lode', setLayout);//웹이지에 있는 이미지 리소스까지 싹다 로딩이되고 실행이 된다.
...
//       // 0
//       type: 'sticky',
//       heightNum: 4.3, // 브라우저 높이의 5배로 scrollHeight 세팅(디바이스 마다 높이가 다르기에 각 기계가 가진 높이를 불러오고 곱해준다.)
//       scrollHeight: 0,
//     },
//     {
//       // 1
