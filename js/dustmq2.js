...
<body class="before-load">
	...
	<div class="container">
		...
		<section class="normal-content">
			<p class="mid-message">
				Lorem ipsum dolor sit amet consectetur adipisicing elit. Tempore voluptas sit officiis odio mollitia tenetur consectetur consequuntur delectus harum sapiente? Architecto, quisquam esse provident, in libero unde eaque assumenda enim quibusdam, soluta consequuntur? Corporis dolores, quae provident doloribus non a temporibus sunt consequuntur, enim minima suscipit accusantium repellendus iure deleniti laudantium expedita distinctio eveniet iusto in veniam modi quos? Dolor ullam ea tenetur a, animi repellat natus quae numquam nisi eum harum odio! Fugiat optio earum iure voluptatem perferendis reiciendis repudiandae quo. Officiis porro iure, reprehenderit voluptatibus, nobis ipsum, enim eum sed totam laborum facilis voluptatum quam architecto excepturi. Corrupti.
			</p>
		</section>
		<section class="normal-content">
			<p class="mid-message">
		...
		<footer class="footer">2023, aerin</footer>
	</div>
	<script src="js/dustmq.js"></script>
</body>
</html>